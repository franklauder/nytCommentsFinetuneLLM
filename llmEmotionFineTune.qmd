...
nyt_shuffled=nytComments17_sentiments2.sample(frac=1, random_state=42).reset_index(drop=True)
...
train_dataset=nyt_shuffled_small.iloc[:27150]
...
valid_dataset=nyt_shuffled_small.iloc[27150:31029]
...
valid_dataset['label'].value_counts(normalize=True)
